  ...
  <v-container>
        ...
        <article>
            ...
            <section>
                <h2>
                    <v-icon icon="mdi-check" />
                    <span>Reasonable Complexity</span>
                </h2>
            ...
            <section>
                <h2>
                    <v-icon icon="mdi-check" />
                    <span>Use of Good Programming Practices</span>
                </h2>
                <ul>
                    <li>Code is correctly indented, with meaningful names assigned to all model identifiers</li>
